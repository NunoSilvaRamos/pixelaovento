...
function updateLanguage() {
    ...
    elements.forEach(el => {
        ...
        if (text) {
            // For elements with innerHTML (like hero title with <br> and <span>)
...
function initAnimations() {
    const animateElements = document.querySelectorAll(
        '.service-card, .portfolio-item, .about-text, .about-visual, .contact-info, .contact-form, .section-header'
    );
...
contactForm.addEventListener('submit', function(e) {
    ...
    // Reset after a delay (in case form doesn't redirect)
    setTimeout(() => {
